...
public class activity_home extends AppCompatActivity {
    ...
    public void openTimKiemActivity(View view) {
        Intent openTimKiem = new Intent(this,activity_timkiem.class);
        startActivity(openTimKiem);
    }

    public void openTaoCongThucActivity(View view) {
        Intent openTaoCongthuc = new Intent(this,TaoCongThucActivity.class);
